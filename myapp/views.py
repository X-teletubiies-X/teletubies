...
def contacto(request):
    title = 'Contacto Page'
    return render(request, 'contacto.html', {'title': title})

def iniciar(request):
    title = 'Iniciar Sesión Page'
    return render(request, 'iniciarsecion.html', {'title': title})

def registrar(request):
    title = 'Registrar Page'
    return render(request, 'registrar.html', {'title': title})
#
